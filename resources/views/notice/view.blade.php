    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto text-center">
          ...
          <iframe src="http://docs.google.com/gview?url={{ asset($notice->content) }}&amp;embedded=true" style="width:100%; height:700px;" frameborder="0" ></iframe>
          {{-- <embed src="{{ asset($notice->content) }}" type="application/pdf" width="100%" height="600px" /> --}}
          
          <h3 class="text-center">Or</h3>

          <a class="btn btn-info text-center" href="{{ asset($notice->content) }}" download>Download</a>
